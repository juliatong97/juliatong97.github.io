...
$verify_sql =  "SELECT  ft.topic_id, ft.topic_title, ft.forum_id FROM  forum_posts AS  fp LEFT  JOIN forum_topics AS ft ON  fp.topic_id = ft.topic_id  WHERE  fp.post_id  = '".$safe_post_id."'";
...
//this post or topic does not exist header("Location: topiclist.php"); exit;
} else {
...
//free  result mysqli_free_result($verify_res);
